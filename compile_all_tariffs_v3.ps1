...
# 11c_v2. Parse International 2026-27 Cash SOC V2
Log-Info "Parsing International 2026-27 Cash SOC V2..."
$listCash2026V2 = New-Object System.Collections.Generic.List[Object]
$intlCash2627V2File = "S:/Sid Work/1. Apollo/@ Apollo Guwahti/Tarriff Working/Tarrif Reporting Format/Tarrif Masterss/New Tarrifs/APOLLO GUWAHATI OP CASH TARIFF Rcvd on 26-06-26.xlsx"
if (Test-Path $intlCash2627V2File) {
    $wb = $excel.Workbooks.Open($intlCash2627V2File, [Type]::Missing, $true)
    $sheet = $wb.Worksheets.Item(1)
    $values = $sheet.UsedRange.Value2
    $rowCount = $sheet.UsedRange.Rows.Count
    $colCount = $sheet.UsedRange.Columns.Count
    ...
    for ($r = ($headerRow + 1); $r -le $rowCount; $r++) {
        ...
        $listCash2026V2.Add([PSCustomObject]@{
            id = $code
            name = $name
            type = $type
            dept = $dept
    ...
    Log-Info "Warning: International 2026-27 Cash SOC V2 file not found at $intlCash2627V2File"
}
...
$jsonCash2026_V2 = $listCash2026V2 | ConvertTo-Json -Depth 5
...
$json2021_IOCL = if ($json2021_IOCL) { $json2021_IOCL } else { "[]" }
...
$jsonCash2026_V2 = if ($jsonCash2026_V2) { $jsonCash2026_V2 } else { "[]" }
...
const ROOM_RENT_2021 = $jsonRoomRent2021;
...
const TARIFF_2021_IOCL = $json2021_IOCL;
...
const TARIFF_CASH_2026_V2 = $jsonCash2026_V2;
...
Log-Info "International Cash SOC 26-27 V2 records: $($listCash2026V2.Count)"
